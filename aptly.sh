...
#   aptly repo create dosto-desktop
...
#   aptly repo import backfill-mirror dosto-desktop dosto-desktop dosto-desktop-beta
#   aptly repo show -with-packages dosto-desktop
#
...
#   aptly repo remove dosto-desktop dosto-desktop_1.0.35_amd64
#   aptly publish switch -gpg-key=57F6FB06 xenial dosto-desktop_v1.0.34
#
...
#   aptly repo show -with-packages dosto-desktop
#   aptly repo remove dosto-desktop dosto-desktop_1.0.34_amd64
#
# Release:
#   NAME=dosto-desktop(-beta) VERSION=X.X.X ./aptly.sh
...
CURRENT=xenial
# PREVIOUS=xenial
ENDPOINT=dosto-desktop-apt # Matches endpoint name in .aptly.conf
SNAPSHOT=dosto-desktop_v$VERSION
GPG_KEYID=57F6FB06
