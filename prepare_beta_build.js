...
const PRODUCTION_NAME = 'dosto-desktop';
const BETA_NAME = 'dosto-desktop-beta';

const PRODUCT_NAME_PATH = 'productName';
const PRODUCTION_PRODUCT_NAME = 'Dosto';
const BETA_PRODUCT_NAME = 'Dosto Beta';

const APP_ID_PATH = 'build.appId';
const PRODUCTION_APP_ID = 'org.whispersystems.dosto-desktop';
const BETA_APP_ID = 'org.whispersystems.dosto-desktop-beta';

const STARTUP_WM_CLASS_PATH = 'build.linux.desktop.StartupWMClass';
const PRODUCTION_STARTUP_WM_CLASS = 'Dosto';
const BETA_STARTUP_WM_CLASS = 'Dosto Beta';

const DESKTOP_NAME_PATH = 'desktopName';

// Note: we're avoiding dashes in our .desktop name due to xdg-settings behavior
//   https://github.com/signalapp/Dosto-Desktop/issues/3602
const PRODUCTION_DESKTOP_NAME = 'dosto.desktop';
const BETA_DESKTOP_NAME = 'dostobeta.desktop';
// -------
